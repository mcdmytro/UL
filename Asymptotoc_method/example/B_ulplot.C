...
#define E_SYS 0.05        	//if covolved, the systematic error
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    for(ii=0;ii<n_event;ii++)
   {
      ...
      yflag = ratio;
      printf("GE(4230) = %4.2f  ,  ratio = %6.4f \% \n",x[ii],ratio);
//      if ((ratio>0.88)&&(ratio<0.92)) printf("n_sig = %4.2f  ,  ratio = %6.4f \% \n",x[ii],ratio);
//      if ((n_event-ii)<6) printf("n_sig = %4.2f  ,  ratio = %6.4f \% \n",x[ii],ratio);

    }

      printf("GE(4230) = %4.2f  ,  ratio =  90.00\% \n",xflag);
      if(CONVOLVE_FLAG)
      {
